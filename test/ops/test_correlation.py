...
class PixelwiseGroupCorrelationTest(unittest.TestCase):
    ...
    def test_pixelwise_group_correlation(self):
        ...
        self.assertAlmostEqual(1.0, ds.canonical_correlation.values[0, 1], places=8)
        self.assertAlmostEqual(1.0, ds.canonical_correlation.values[1, 0], places=8)
        self.assertAlmostEqual(1.0, ds.canonical_correlation.values[1, 1], places=8)
